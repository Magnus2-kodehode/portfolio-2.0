        ...
        <div className='container-column'>
          ...
          <div className='container-skills'>
            <div className='skill'>
              ...
              <p><b>HTML (HyperText Markup Language):</b> Språket som brukes for å strukturere innhold på nettsider. Det definerer elementer som overskrifter, avsnitt, lenker, bilder osv.</p>
            </div>
            <div className='skill'>
